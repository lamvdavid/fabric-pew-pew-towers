...
public class FireballTowerBlockEntity extends LineTowerBlockEntity{
    ...
    protected ProjectileEntity createProjectile(World world, Position position) {
        FireballEntity fireball = new FireballEntity(world, position.getX(), position.getY(), position.getZ(), target.getX() - position.getX(), target.getY() - position.getY(), target.getZ() - position.getZ());
